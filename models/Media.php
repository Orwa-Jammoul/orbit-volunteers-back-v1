...
class Media
{
    ...
    public function getImages($albumId)
    {
        ...
        foreach ($images as &$image) {
            $image['image_base64'] = $this->getImageBase64FromUrl($image['image_url']);
        }
    ...
    /**
     * Convert a local image URL or path into a base64 data URI if possible.
     */
    public function getImageBase64FromUrl($url)
    {
        if (empty($url)) {
            return null;
        }
